...
export class King extends AbstractFigure implements Figure  {
    ...
    possibleMoves() {
        ...
        if (this.chessboard[this.position.y] && this.chessboard[this.position.y][this.position.x-1] && this.chessboard[this.position.y][this.position.x-1].color === !this.color) {
            this.moviesForFigure.push({y: this.position.y, x: this.position.x-1});
        }
        ...
        if (this.chessboard[this.position.y-1] && this.chessboard[this.position.y-1][this.position.x-1] && this.chessboard[this.position.y-1][this.position.x-1].color === !this.color) {
            this.moviesForFigure.push({y: this.position.y-1, x: this.position.x-1});
        }
        ...
        if (this.chessboard[this.position.y+1] && this.chessboard[this.position.y+1][this.position.x] && this.chessboard[this.position.y+1][this.position.x].color === !this.color) {
            this.moviesForFigure.push({y: this.position.y+1, x: this.position.x});
        }
